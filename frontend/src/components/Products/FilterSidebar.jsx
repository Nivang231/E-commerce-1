...
const FilterSidebar = () => {
    ...
    const brands = [
        "Urban Threads", "Modern Fit", "Street Style", "Beach Breeze", "Fashionista", "ChickStyle"
    ];
    ...
    <div className='p-4'>
        ...
        <div className='mb-6'>
            ...
            {categories.map((category) => (
                <div key={category} className='flex items-center mb-1'>
                    ...
                    onChange={handleFilterChange} checked={filters.category === category}
        ...
        <div className='mb-6'>
            ...
            {genders.map((gender) => (
                <div key={gender} className='flex items-center mb-1'>
                    ...
                    onChange={handleFilterChange} checked={filters.gender === gender}
                    className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300' />
        ...
        <div className='mb-6'>
            ...
            {sizes.map((size) => (
                <div key={size} className='flex items-center mb-1'>
                    ...
                    onChange={handleFilterChange} checked={filters.size.includes(size)}
        ...
        <div className='mb-6'>
            ...
            {materials.map((material) => (
                <div key={material} className='flex items-center mb-1'>
                    ...
                    onChange={handleFilterChange} checked={filters.material.includes(material)}
                    className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-4000 border-gray-300' />
        ...
        <div className='mb-6'>
            ...
            {brands.map((brand) => (
                <div key={brand} className='flex items-center mb-1'>
                    ...
                    onChange={handleFilterChange} checked={filters.brand.includes(brand)}
                    className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-4000 border-gray-300' />
        ...
        <div className='mb-8'>
            ...
            <input type="range" name='priceRange' min={0} max={100}
             ...
             value={priceRange[1]} onChange={handlePriceChange} />
