...
const NewArrivals = () => {
    ...
    const updateScrollButtons = () => {
        ...
        console.log({
            ...
            conatinerScollWidth: container.scrollWidth,
        })
    }
    ...
    return (
        <section>
            <div className='container mx-auto max-w-7xl text-center mb-10 relative'>
            ...
            <div ref={scrollRef} className='container mx-auto overflow-x-scroll flex space-x-6 relative'>
                {newArrivals.map((product) => (
                    <div key={product._id} className='min-w-[100%] sm:win-w-[50%] lg:min-w-[30%] relative'>
